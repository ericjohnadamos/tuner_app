...
@implementation TMOTheme

- (void) skinButton: (UIButton*) button
{
  /* TODO: Implement if you want to have a core design for general buttons */
}

- (void) skinHelpButton: (UIButton*) button
{
  /* TODO: Implement if you want to have a core design for help button */
}
